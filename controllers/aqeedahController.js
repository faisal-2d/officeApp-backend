// usersController.js
const aqeedahModel = require('../models/aqeedahModel');

async function registerStudent(req, res) {
    const batch_no = req.params.batch;
    const student = req.body;
    try {
        await aqeedahModel.registerStudent(student, batch_no);
...
async function getStudents(req, res) {
    const batch_no = req.params.batch;
    try {
        const users = await aqeedahModel.getStudents(batch_no);
...
async function getStudentByName(req, res) {
    ...
    try {
        const users = await aqeedahModel.getStudentByName(batch_no, name);
        res.status(201).send(users);
    } catch (error) {
        console.error('Error creating user:', error);
        res.status(500).send('Internal Server Error');
...
async function getStudentById(req, res) {
    ...
    try {
        const users = await aqeedahModel.getStudentById(batch_no, sn);
        res.status(201).send(users);
    } catch (error) {
        console.error('Error creating user:', error);
        res.status(500).send('Internal Server Error');
...
async function getTotalStudents(req, res) {
    const batch_no = req.params.batch;
    try {
        const result = await aqeedahModel.getTotalStudents(batch_no);
...
async function updatePayment(req, res) {
    ...
    try {
        const result = await aqeedahModel.updatePayment(batch_no, sn, payment);
        res.status(200).send({'sn': sn ,'success' : true, 'result': result})
    } catch (error) {
        console.error('Error creating user:', error);
        res.status(500).send('Internal Server Error');
...
async function getLeaderboard(req, res) {
    ...
    try {
        const result = await aqeedahModel.getLeaderboard(batch_no, level);
...
async function accessLevelTwo(req, res) {
    ...
    const data = req.body;
    try {
        const result = await aqeedahModel.accessLevelTwo(batch_no, sn, data);
        res.status(200).send({'success' : true, 'result': result})
    } catch (error) {
        console.error('Error creating user:', error);
        res.status(500).send('Internal Server Error');
...
async function certificateUpload(req, res) {
    ...
    try {
        const result = await aqeedahModel.certificateUpload(batch_no, level, sn, certificate);
        res.status(200).send({'success' : true, 'result': result})
    } catch (error) {
        console.error('Error creating user:', error);
        res.status(500).send('Internal Server Error');
