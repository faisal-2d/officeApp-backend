...
async function run() {
    try {
      ...
      const seerat_4_list = client.db("seerat").collection("seerat_4_list");     
  ...
  //   searchbar by name 
    // http://localhost:5000/aqeedah_16/afrin
      ...
      //get count
      http://localhost:5000/count/fiqh/87
      app.get("/count/fiqh/8", async (req, res) => {
        const result = await fiqh_8_list.countDocuments();
        res.status(200).json({'success' : true, 'result': result})
      });

    //   searchbar by name 
    // http://localhost:5000/fiqh_17/afrin
      app.get("/fiqh/8/:name", async (req, res) => {
        const name = req.params.name.toLowerCase();
        const query = {name : {$regex :name}};
        const options = {
            sort: { "sn": 1 }
          };
        const result = await fiqh_8_list.find(query, options).toArray();
        res.send(result);
      });

      //get by sn
      http://localhost:5000/student/13
      app.get("/fiqh/8/sn/:sn", async (req, res) => {
        const sn = parseInt(req.params.sn);
        const query = {sn : sn};
        const result = await fiqh_8_list.findOne(query);
        res.send(result);
      });

      //create a new stud
    // http://localhost:5000/product
    app.post("/register/fiqh/8", async (req, res) => {
      const stud = req.body;
      const result = await fiqh_8_list.insertOne(stud);
      res.send({ success: true, result});
    });
      ...
      // update filed 
      http://localhost:5000/levelOne/13
      app.put("/fiqh8/level1/exm1/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : { [`fiqh1data.${[0]}`] : req.body } ,
        }    
        const result = await fiqh_8_list.updateOne(filter, updateDocument);      
        res.send({ success: true, result});
      });

      app.put("/fiqh8/level1/exm2/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/fiqh8/level1/exm3/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/fiqh8/level2/exm1/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/fiqh8/level2/exm2/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/fiqh8/level2/exm3/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      // update filed 
      http://localhost:5000/levelOne/13
      app.put("/payment/fiqh/8/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set :  req.body,
      ...
      //  total mark
      http://localhost:5000/level3/13
      app.put("/fiqh8/level1/leaderboard/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn};
        const getStud = await fiqh_8_list.findOne(filter);
        const updateDocument = await {  
      ...
      http://localhost:5000/level3/13
      app.put("/fiqh8/level2/leaderboard/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn};
        const getStud = await fiqh_8_list.findOne(filter);
        const updateDocument = await {  
      ...
      // promote to level2+3 
      http://localhost:5000/levelOne/13
      app.put("/accessLevelTwo/fiqh8/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set :  req.body,
      ...
      app.get("/leaderboard/fiqh1/8", async (req, res) => {
        const query = {};
        const options = {
            sort: { "fiqh1Total": -1 }
          };
      ...
      app.get("/leaderboard/fiqh2/8", async (req, res) => {       
        const options = {
            sort: { "fiqh2Total": -1 }
          };
        const result = await fiqh_8_list.find({"fiqh2data":{$ne:null}}, options).toArray();
        res.send(result);
      });

      //http://localhost:5000/level3/13
      app.put("/fiqh8/level1/certificate/:sn", async (req, res) => {   
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/fiqh8/level2/certificate/:sn", async (req, res) => {   
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      //get count
      http://localhost:5000/count/fiqh/77
      app.get("/count/fiqh/7", async (req, res) => {
        const result = await fiqh_7_list.countDocuments();
        res.status(200).json({'success' : true, 'result': result})
      });

    //   searchbar by name 
    // http://localhost:5000/fiqh_17/afrin
      app.get("/fiqh/7/:name", async (req, res) => {
        const name = req.params.name.toLowerCase();
        const query = {name : {$regex :name}};
        const options = {
            sort: { "sn": 1 }
          };
        const result = await fiqh_7_list.find(query, options).toArray();
        res.send(result);
      });

      //get by sn
      http://localhost:5000/student/13
      app.get("/fiqh/7/sn/:sn", async (req, res) => {
        const sn = parseInt(req.params.sn);
        const query = {sn : sn};
        const result = await fiqh_7_list.findOne(query);
        res.send(result);
      });

      //create a new stud
    // http://localhost:5000/product
    app.post("/register/fiqh/7", async (req, res) => {
      const stud = req.body;
      const result = await fiqh_7_list.insertOne(stud);
      res.send({ success: true, result});
    });
      ...
      // update filed 
      http://localhost:5000/levelOne/13
      app.put("/fiqh7/level1/exm1/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : { [`fiqh1data.${[0]}`] : req.body } ,
        }    
        const result = await fiqh_7_list.updateOne(filter, updateDocument);      
        res.send({ success: true, result});
      });

      app.put("/fiqh7/level1/exm2/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : { [`fiqh1data.${[1]}`] : req.body } ,
      ...
      app.put("/fiqh7/level1/exm3/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : { [`fiqh1data.${[2]}`] : req.body } ,
      ...
      app.put("/fiqh7/level2/exm1/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : { [`fiqh2data.${[0]}`] : req.body } ,
      ...
      app.put("/fiqh7/level2/exm2/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : { [`fiqh2data.${[1]}`] : req.body } ,
      ...
      app.put("/fiqh7/level2/exm3/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : { [`fiqh2data.${[2]}`] : req.body } ,
      ...
      // update filed 
      http://localhost:5000/levelOne/13
      app.put("/payment/fiqh/7/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set :  req.body,
      ...
      //  total mark
      http://localhost:5000/level3/13
      app.put("/fiqh7/level1/leaderboard/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn};
        const getStud = await fiqh_7_list.findOne(filter);
        const updateDocument = await {  
          $set : {'fiqh1Total' : getStud.fiqh1data[0].Score +
                                    getStud.fiqh1data[1].Score + 
                                    getStud.fiqh1data[2].Score} ,
      ...
      http://localhost:5000/level3/13
      app.put("/fiqh7/level2/leaderboard/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn};
        const getStud = await fiqh_7_list.findOne(filter);
        const updateDocument = await {  
      ...
      // promote to level2+3 
      http://localhost:5000/levelOne/13
      app.put("/accessLevelTwo/fiqh7/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set :  req.body,
      ...
      // leaderboard fetch
      // http://localhost:5000/fiqh_16/afrin
      app.get("/leaderboard/fiqh1/7", async (req, res) => {
        const query = {};
        const options = {
            sort: { "fiqh1Total": -1 }
          };
      ...
      app.get("/leaderboard/fiqh2/7", async (req, res) => {       
        const options = {
            sort: { "fiqh2Total": -1 }
          };
        const result = await fiqh_7_list.find({"fiqh2data":{$ne:null}}, options).toArray();
        res.send(result);
      });

      //http://localhost:5000/level3/13
      app.put("/fiqh7/level1/certificate/:sn", async (req, res) => {   
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : {'fiqhCourseCertificates.level1' : req.body.certificate},
      ...
      app.put("/fiqh7/level2/certificate/:sn", async (req, res) => {   
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : {'fiqhCourseCertificates.level2' : req.body.certificate},
    ...
    app.post("/register/fiqh/1", async (req, res) => {
      ...
      //get count
      http://localhost:5000/count/seerat/47
      app.get("/count/seerat/4", async (req, res) => {
        const result = await seerat_4_list.countDocuments();
        res.status(200).json({'success' : true, 'result': result})
      });

    //   searchbar by name 
    // http://localhost:5000/seerat_17/afrin
      app.get("/seerat/4/:name", async (req, res) => {
        const name = req.params.name.toLowerCase();
        const query = {name : {$regex :name}};
        const options = {
            sort: { "sn": 1 }
          };
        const result = await seerat_4_list.find(query, options).toArray();
        res.send(result);
      });

      //get by sn
      http://localhost:5000/student/13
      app.get("/seerat/4/sn/:sn", async (req, res) => {
        const sn = parseInt(req.params.sn);
        const query = {sn : sn};
        const result = await seerat_4_list.findOne(query);
        res.send(result);
      });

       //create a new stud
    // http://localhost:5000/product
    app.post("/register/seerat/4", async (req, res) => {
      const stud = req.body;
      const result = await seerat_4_list.insertOne(stud);
      res.send({ success: true, result});
    });
      ...
      // update filed 
      http://localhost:5000/levelOne/13
      app.put("/seerat4/level1/exm1/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : { [`seerat1data.${[0]}`] : req.body } ,
        }    
        const result = await seerat_4_list.updateOne(filter, updateDocument);      
        res.send({ success: true, result});
      });

      app.put("/seerat4/level1/exm2/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/seerat4/level1/exm3/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/seerat4/level2/exm1/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/seerat4/level2/exm2/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/seerat4/level2/exm3/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      // update filed 
      http://localhost:5000/levelOne/13
      app.put("/payment/seerat/4/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set :  req.body,
      ...
      //  total mark
      http://localhost:5000/level3/13
      app.put("/seerat4/level1/leaderboard/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn};
        const getStud = await seerat_4_list.findOne(filter);
        const updateDocument = await {  
      ...
      http://localhost:5000/level3/13
      app.put("/seerat4/level2/leaderboard/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn};
        const getStud = await seerat_4_list.findOne(filter);
        const updateDocument = await {  
      ...
      // promote to level2+3 
      http://localhost:5000/levelOne/13
      app.put("/accessLevelTwo/seerat4/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set :  req.body,
      ...
      app.get("/leaderboard/seerat1/4", async (req, res) => {
        const query = {};
        const options = {
            sort: { "seerat1Total": -1 }
          };
      ...
      app.get("/leaderboard/seerat2/4", async (req, res) => {       
        const options = {
            sort: { "seerat2Total": -1 }
          };
        const result = await seerat_4_list.find({"seerat2data":{$ne:null}}, options).toArray();
        res.send(result);
      });

      //http://localhost:5000/level3/13
      app.put("/seerat4/level1/certificate/:sn", async (req, res) => {   
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/seerat4/level2/certificate/:sn", async (req, res) => {   
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
    ...
    app.post("/register/seerat/1", async (req, res) => {
      ...
      //get count
      http://localhost:5000/count/tafseer/67
      app.get("/count/tafseer/6", async (req, res) => {
        const result = await tafseer_6_list.countDocuments();
        res.status(200).json({'success' : true, 'result': result})
      });

    //   searchbar by name 
    // http://localhost:5000/tafseer_17/afrin
      app.get("/tafseer/6/:name", async (req, res) => {
        const name = req.params.name.toLowerCase();
        const query = {name : {$regex :name}};
        const options = {
            sort: { "sn": 1 }
          };
        const result = await tafseer_6_list.find(query, options).toArray();
        res.send(result);
      });

      //get by sn
      http://localhost:5000/student/13
      app.get("/tafseer/6/sn/:sn", async (req, res) => {
        const sn = parseInt(req.params.sn);
        const query = {sn : sn};
        const result = await tafseer_6_list.findOne(query);
        res.send(result);
      });

       //create a new stud
    // http://localhost:5000/product
    app.post("/register/tafseer/6", async (req, res) => {
      const stud = req.body;
      const result = await tafseer_6_list.insertOne(stud);
      res.send({ success: true, result});
    });
      ...
      // update filed 
      http://localhost:5000/levelOne/13
      app.put("/tafseer6/level1/exm1/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set : { [`tafseer1data.${[0]}`] : req.body } ,
        }    
        const result = await tafseer_6_list.updateOne(filter, updateDocument);      
        res.send({ success: true, result});
      });

      app.put("/tafseer6/level1/exm2/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/tafseer6/level1/exm3/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/tafseer6/level2/exm1/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/tafseer6/level2/exm2/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/tafseer6/level2/exm3/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      // update filed 
      http://localhost:5000/levelOne/13
      app.put("/payment/tafseer/6/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
          $set :  req.body,
      ...
      //  total mark
      http://localhost:5000/level3/13
      app.put("/tafseer6/level1/leaderboard/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn};
        const getStud = await tafseer_6_list.findOne(filter);
        const updateDocument = await {  
      ...
      http://localhost:5000/level3/13
      app.put("/tafseer6/level2/leaderboard/:sn", async (req, res) => {      
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn};
        const getStud = await tafseer_6_list.findOne(filter);
        const updateDocument = await {  
      ...
      app.get("/leaderboard/tafseer1/6", async (req, res) => {
        const query = {};
        const options = {
      ...
      app.get("/leaderboard/tafseer2/6", async (req, res) => {       
        const options = {
            sort: { "tafseer2Total": -1 }
          };
        const result = await tafseer_6_list.find({"tafseer2data":{$ne:null}}, options).toArray();
        res.send(result);
      });

      //http://localhost:5000/level3/13
      app.put("/tafseer6/level1/certificate/:sn", async (req, res) => {   
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
      ...
      app.put("/tafseer6/level2/certificate/:sn", async (req, res) => {   
        const sn = parseInt(req.params.sn);
        const filter = {sn : sn}; 
        const updateDocument = {
